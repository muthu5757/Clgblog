...
<body>
  <script src="blogfun.js" type="text/javascript"></script>
    ...
    <p>These are the Magazine posts of the Department of Computer <br>Application (BCA), Sri Kaliswari college (Autonomous) , Sivakasi.</p><br>
    <button id="ch" type="submit" name="clicktoblog" onclick="blog(null)" target="_self" >Back</button><br><br><br> 
    </div>
    <img src="pictures/class.png" width="33%" height="40%"/>
  </div><br>
